...
//whether user requested different time than real time on computer
$posted_current_time;
$posted = false;
...
function standardize_coors($available_stops){
    ...
    foreach($available_stops as $stop){
        $stop_x = (int) (($stop["x"]-$translation_x)*(2/$scale)*200 + 300);
        $stop_y = (int) (-($stop["y"]-$translation_y)*(2/$scale)*200 + 200); //flipped negative is a mcgyver solution
...
//     echo "worked!";
//     if(isset($_POST["hour"]) and isset($_POST["minutes"]) and isset($_POST["seconds"])){
//         $hour = (int)$_POST["hour"];
//         $minutes = (int)$_POST["minutes"];
//         $seconds = (int)$_POST["seconds"];
//         $posted_current_time = mktime($hour,$minutes,$seconds);
//         echo $posted_current_time;
//         $posted = true;
//     }
// }else{
//     $posted = false;
